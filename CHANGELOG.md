...
### Доделать
- логгер для матчинг-енжина
- инстансы енжинов - через DI
- адаптировать тесты для DI
- тесты и прогон всех команд - контроль выполнения, логирование, результат
- API для бинарных команд
- интеграционные тесты и прогон базовых сценариев
